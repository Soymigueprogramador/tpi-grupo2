    ...
    */
    ...
    while (!finalizar)
    {
        ...
        case 1:
            ...
            { // Solo la activamos una vez para indicar que al menos una partida se jugó
                partidaJugada = true;
            }
            ...
            { // Si tiene mas puntaje el jugador que empezó
                if (puntajeJugador1 > maxPuntajeHistorico)
                {                                                 // Si tiene mas puntaje que el maximo historico, que empieza con 0
                ...
                if (puntajeJugador2 > maxPuntajeHistorico)
                { // lo mismo que para el jugador 1 si se gana
            ...
            { // si ni j1 ni j2 tienen mas puntaje que el otro, quiere decir empate
